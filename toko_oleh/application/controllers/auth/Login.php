...
class Login extends CI_Controller {
    ...
    public function LoginApi(){//berfungsi untuk membuat function Api
        $data = $this -> Login_model -> getAll();//berfungsi untuk memanggil data dari database melalui file mahasiswa_model
