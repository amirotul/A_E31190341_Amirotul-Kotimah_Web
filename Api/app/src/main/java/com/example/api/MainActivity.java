...
import com.example.api.Adapter.AdapterData;
import com.example.api.Model.ModelData;
import com.example.api.Util.AppController;
import com.example.api.Util.ServerAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, com.example.api.InsertData.class);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hapus = new Intent(MainActivity.this, com.example.api.Delete.class);
                startActivity(hapus);
            }
        });
    }
